...
class Material(models.Model):
    ...
    file = models.FileField(upload_to='lassons/materials', blank=True, null=True)
...
def post_save_announcement(instance, created, **kwargs):
    ...
    if created:
        ...
        for enrollment in enrollments:
            recipeint_list = [enrollment.user.email]
            send_mail_template(subject, template_name, context, recipeint_list)
